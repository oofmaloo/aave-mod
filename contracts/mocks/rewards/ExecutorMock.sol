...
//   address constant REWARD_TOKEN = 0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9;
...
//     address[] memory assets = _pool.getReservesList()
...
// 		);
// 		DataTypes.ReserveData memory reserveData = ILendingPoolData(LENDING_POOL).getReserveData(reserves[x]);


// 		IAaveIncentivesController incentivesController = getIncentivesController()
