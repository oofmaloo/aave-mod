...
library ValidationLogic {
    ...
    view
  {
    ...
    require(reserveCache.aggregatorAddress != address(0), 'ERROR_AGGREGATOR_ADDRESS_ZERO');
  ...
  function validateBorrow(
    ...
    // cannot fold same asset 
    require(
      !params.userConfig.isUsingAsCollateral(reservesData[params.asset])
    ...
    if (params.interestRateMode == DataTypes.InterestRateMode.STABLE) {
      ...
      vars.availableLiquidity = IAggregator(params.reserveCache.aggregatorAddress).getLiquidity();
  ...
  function validateRebalanceStableBorrowRate(
    ...
    // uint256 avgBorrowRate = IInterestRateOracle(reserve.interestRateOracleAddress).getLastAverageBorrowRate();
    ...
    (uint256 liquidityRateVariableDebtOnly, , ) = IReserveInterestRateStrategy(
      reserve.interestRateStrategyAddress
        ...
        DataTypes.CalculateInterestRatesParams({
          ...
          aggregator: reserve.aggregatorAddress
        })
      );
