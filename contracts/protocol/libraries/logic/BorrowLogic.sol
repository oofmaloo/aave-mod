...
library BorrowLogic {
  ...
  function executeBorrow(
    ...
    if (params.releaseUnderlying) {
      ...
      IAggregator(reserve.aggregatorAddress).redeem(params.amount, params.user);
    }
  ...
  function executeRepay(
    ...
    if (params.useATokens) {
      ...
      // send to aggregator with no following action
      // next depositor will handle optimization with no added gas
      IERC20(params.asset).safeTransferFrom(msg.sender, reserve.aggregatorAddress, paybackAmount);
    }
