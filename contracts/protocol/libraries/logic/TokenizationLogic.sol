...
library TokenizationLogic {
  ...
  function executeInitBorrowReserve(IPool pool, ITokenizationHelper tokenizationHelper, ConfiguratorInputTypes.InitReserveInput calldata input)
    public
  {
