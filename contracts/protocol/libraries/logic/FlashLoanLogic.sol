...
library FlashLoanLogic {
  ...
  function executeFlashLoan(
    ...
    for (vars.i = 0; vars.i < params.assets.length; vars.i++) {
      ...
      //   vars.currentAmount
      // );
      IAggregator(reservesData[params.assets[vars.i]].aggregatorAddress).redeemOnFlash(vars.currentAmount, params.receiverAddress);
    }
  ...
  function executeFlashLoanSimple(
    ...
    IAggregator(reserve.aggregatorAddress).redeemOnFlash(params.amount, params.receiverAddress);
  ...
  function _handleFlashLoanRepayment(
    ...
    IERC20(params.asset).safeTransferFrom(
      params.receiverAddress,
      reserve.aggregatorAddress,
      amountPlusPremium
    );

    IAggregator(reserve.aggregatorAddress).deposit(amountPlusPremium);
