...
contract PoolAddressesProvider is Ownable, IPoolAddressesProvider {
  ...
  bytes32 private constant POOL_AGGREGATOR_CONFIGURATOR  = 'POOL_AGGREGATOR_CONFIGURATOR';
  ...
  function setPool(address newPool) external override onlyOwner {
    ...
    emit PoolUpdated(oldPoolImpl, newPool);
  }
  ...
  function getPoolAggregatorConfigurator() external view override returns (address) {
    return getAddress(POOL_AGGREGATOR_CONFIGURATOR);
  }

  function setPoolAggregatorConfigurator(address newPoolAggregatorConfigurator) external override onlyOwner {
    address oldPoolAggregatorConfigurator = _addresses[POOL_CONFIGURATOR];
    _addresses[POOL_AGGREGATOR_CONFIGURATOR] = newPoolAggregatorConfigurator;
    emit PoolUpdated(oldPoolAggregatorConfigurator, newPoolAggregatorConfigurator);
  }
  ...
  function setPoolConfigurator(address newPoolConfigurator) external override onlyOwner {
