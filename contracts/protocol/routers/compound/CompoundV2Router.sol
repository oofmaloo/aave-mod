...
//  */
// contract CompoundRouterV3 is Helper, IRouter {
...
//         CErc20 cToken = CErc20(asset);
//         uint mintResult = cToken.mint(amount);

//         console.log("AaveRouter v2 balanceOf", IERC20(asset).balanceOf(address(this)));
...
//             0
//         );
//         console.log("AaveRouter v2 deposit after");
//     }

//     function deposit(address asset, uint256 amount, address to) public override {
//     }

//     function redeem(address asset, uint256 amount, address to) public override returns (uint256) {
//         uint256 finalRedeemed = IPool(aavePool).withdraw(
//             asset,
//             amount,
//             to
//         );
//         console.log("redeem finalRedeemed", finalRedeemed);
//         return finalRedeemed;
//     }

//     function redeemDelegate(address asset, uint256 amount, address to) public override returns (uint256) {
//         // (bool success,) = aavePool.delegatecall(
...
//         //     to
//         // );
//         // console.log("redeemDelegate finalRedeemed", finalRedeemed);
//         return 0;
//     }
...
//      * - All Aave ATokens are decimals accurate to underlying asset, no need for conversion
//      */
...
//     function getTokenization(address asset) external view returns (address[] memory) {
//         address[] memory assets = new address[](2);
//         (
//             address aTokenAddress,
//             address variableDebtTokenAddress,
//             address stableDebtTokenAddress
//         ) = IAaveProtocolDataProvider(aaveDataProvider).getReserveTokensAddresses(asset);

//         assets[0] = aTokenAddress;
//         assets[1] = variableDebtTokenAddress;
//         assets[2] = stableDebtTokenAddress;
...
//     // claim multi awards if protocol has more than one
