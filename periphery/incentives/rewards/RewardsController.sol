...
//  each aToken has 1 RewardsController && 1 EmissionManager
//  each RewardsController deploys 1 RewardsDistributor
//  each RewardsDistributor has_many rewards assets
