...
export async function token_dividends_setup(
  ...
  console.log("dividendManagerAddress", _dividendManager.address)
  console.log("dividendsControllerAddress", _dividendsController.address)
  console.log("stakedAddiAddress", _stakedAddi.address)
  console.log("addiTokenAddress", _addi.address)
